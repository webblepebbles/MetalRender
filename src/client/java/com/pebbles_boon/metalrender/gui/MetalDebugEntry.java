...
public final class MetalDebugEntry implements DebugScreenEntry {
  private static final Identifier DBG_GRP =
      Identifier.fromNamespaceAndPath("metalrender", "debug_group");
  private static final Identifier DBG_ID =
      Identifier.fromNamespaceAndPath("metalrender", "debug");
  ...
  private static Map<Identifier, DebugScreenEntry> registry()
    ...
    Map<Identifier, DebugScreenEntry> reg =
        (Map<Identifier, DebugScreenEntry>)f.get(null);
    return reg;
  }
  ...
  private static final class SysSpecEntry implements DebugScreenEntry {
    private static final Identifier SYS_GRP =
        Identifier.withDefaultNamespace("system");
