...
public final class MetalRenderConfig {
  ...
  private static void normalizeLodGroundwork() {
    zone0RadiusChunks = clamp(zone0RadiusChunks, 16, DEFAULT_ZONE0_RADIUS_CHUNKS);
    farFieldRadiusChunks = clamp(farFieldRadiusChunks,
        zone0RadiusChunks + 32,
  ...
  private static float estimateBlockFacePixels(int chunkDistance) {
